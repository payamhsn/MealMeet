      ...
      <nav className="fixed hidden md:flex z-30 w-full md:px-10 px-5 text-white backdrop-blur-md shadow-md">
        <Link to="/home" className="flex items-center">
          <span className="self-center text-[#ffc20d] text-2xl font-bold whitespace-nowrap ">
            <img src="/assets/logo2.png" alt="logo" className="w-10" />
          </span>
        </Link>
          ...
          <div className="hidden w-full md:block md:w-auto">
            <ul className="flex font-bold tracking-wider p-4 md:p-0 mt-4 border rounded-lg md:flex-row md:mt-0 md:border-0  border-gray-700">
              <li>
                <Link
                  to="/search"
                  className="block focus:text-[#00a8b0] border-2 p-1.5 border-transparent hover:border-white rounded-full hover:text-[#00a8b0] "
                >
                  <svg
              ...
              <li>
                <Link
                  to="/home"
                  className="md:pl-10 hover:underline hover:underline-offset-4 focus:underline focus:underline-offset-8 block py-2 rounded focus:text-[#00a8b0] md:hover:bg-transparent"
                >
                  Home
                </Link>
              </li>
